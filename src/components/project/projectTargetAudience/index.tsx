  ...
  return (
    ...
    >
      <div className={`bg-[#FFFEF6] flex flex-col items-center gap-1.5 border border-[#040008] rounded-4xl pl-10 pr-5 pt-7 pb-6 xl:pl-14 xl:pr-6 xl:pt-8 xl:pb-7`}>
        ...
        <ul className={`w-[255px] list-['⭐'] list-outside text-[#242325] space-y-2 xl:w-[320px]`}>
          <li className={`font-open-dyslexic text-xl text-shadow-2xs pl-0.5 xl:pl-1 xl:text-2xl`}>
